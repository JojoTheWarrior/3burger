...
document.getElementById('orderForm').addEventListener('submit', async e => {
    ...
    // for rsa encryption
    const N = ; // big int
    const E = 5n;
    ...
    // for local testing
    // const URL 
    const URL = 'https://5f93-2620-101-f000-7c1-00-b6ae.ngrok-free.app/get_burger';
